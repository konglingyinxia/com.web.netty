 ...
 */
public class LuozhuangBenMinghehun {
...
//    巽命男配巽命女，离命男配离命女。
     ...
     * @return 属于宫挂
     */
    public LuozhuangBenMinghehun.basicstring basicsnumber(int number, sex isman) {
        switch (number) {
            case 1:
    ...
    public static void main(String[] args) {
        LuozhuangBenMinghehun my = new LuozhuangBenMinghehun();
